...
Usage:
    echo -e "look\nscore\ninventory" | python3 mud_client.py

Defaults to this project's MUD instance (localhost:4000, dummy/helloworld).
Pass --host/--port/--user/--pass to point at a different server or account.
...
def main():
    ...
    p.add_argument("--user", default="dummy")
    p.add_argument("--pass", dest="password", default="helloworld")
